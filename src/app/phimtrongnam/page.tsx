...
export default function PhimTrongNam() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true);
                const result = await apiService.get(`https://phim.nguonc.com/api/films/nam-phat-hanh/2024?page=${page}&limit=25`);
        ...
        <div className="flex justify-center">
            <div className="w-[1000px]">
                <div className="relative flex items-center justify-between my-3 px-3 md:px-0">
                    <h1 className="text-2xl font-bold ml-3">PHIM TRONG NĂM 2024</h1>
